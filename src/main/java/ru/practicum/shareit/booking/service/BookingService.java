...
public interface BookingService {
    ...
    List<Booking> findByUserIdAndState(Long userId, String state, int from, int size);

    List<Booking> findByOwnerIdAndState(Long ownerId, String state, int from, int size);
