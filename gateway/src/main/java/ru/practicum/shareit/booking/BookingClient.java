...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findAllByUserIdAndState(Long userId, BookingState state, int from, int size) {
    ...
    public ResponseEntity<Object> findAllByOwnerIdAndState(Long ownerId, BookingState state, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
